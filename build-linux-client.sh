...
docker-compose run jpackager create-image --input wordnetloom-client-3.0/ --output . --name wordnetloom --class pl.edu.pwr.wordnetloom.client.Application --main-jar wordnetloom-client-3.0.jar --runtime-image java-runtime/
